...
>
	...
	{:else if worker.state === 'idle'}
		...
		>
			<span class="text-[10px] font-bold tracking-widest text-[#484F58] uppercase"
				>[ IDLE ]</span
			>
		</div>
	{:else}
		...
		>
			<span class="text-[10px] font-bold tracking-widest text-[#484F58]/50 uppercase">[ OFFLINE ]</span>
		</div>
	{/if}
