    ...
    {:else}
        <div class="overflow-y-auto max-h-[calc(100vh-280px)]">
            {#each events as event (event.id)}
                ...
                <div class="flex items-center gap-4 p-4 border-b border-[#30363D] last:border-0 hover:bg-[#1C2128] transition-colors">
                    ...
                    <div class="flex-grow min-w-0">
                        <div class="flex items-center justify-between gap-2">
                            <span class="text-xs font-medium px-2 py-0.5 rounded-full border {styles.bg} {styles.text} {styles.border} uppercase tracking-wider">
